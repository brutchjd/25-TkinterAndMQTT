...
def main():
    ...
    forward_button['command'] = lambda: forward_pressed(left_speed_entry, right_speed_entry, name1, name2)
...
def forward_pressed(left, right, name1, name2):
    ...
    left_send = left.get()
    right_send = right.get()

    mqtt_client.send_message("forward", [left_send, right_send])